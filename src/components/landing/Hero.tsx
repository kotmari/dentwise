...
import { Calendar, Mic2Icon, StarIcon } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-10">
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/10 to-primary/5 rounded-full border-primary/20 backdrop-blur-sm">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed max-w-xl font-medium">
                  Chat with our AI dental assistant for instal advice, book
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <SignUpButton mode="modal">
                  <Button size={"lg"}>
                    <Mic2Icon className="mr-2 size-5" color="#000000" />
                    Try voice chat
                  </Button>
                </SignUpButton>
                <SignUpButton mode="modal">
                  <Button size={"lg"} variant={"outline"}>
                    <Calendar className="mr-2 size-5" color="#000000" />
                    Book appointment
                  </Button>
                </SignUpButton>
              </div>
            ...
            <div className="relative lg:pl-8">
              ...
              <Image src={"/hero.png"} alt="DentWise AI" width={600} height={600} className="w-full h-auto" />
            </div>
          </div>
        </div>
      </div>
