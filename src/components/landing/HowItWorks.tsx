  ...
  return (
    <section className="relative py-32 px-6 outline-hidden z-10 max-w-7xl mx-auto">
      ...
      <div className="relative">
        <div className="absolute top-1/5 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary/30 to-transparent transform -translate-y-1/2 hidden lg:block"></div>

        <div className="grid lg:grid-cols-3 gap-12 lg:gap-8">
          <div className="relative group">
            <div className="relative bg-gradient-to-br from-card/90 to-card/40 backdrop-blur-xl rounded-3x p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
          ...
          <div className="relative group">
            <div className="relative bg-gradient-to-br from-card/90 to-card/40 backdrop-blur-xl rounded-3x p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              ...
              <p className="text-muted-foreground text-center leading-relaxed mb-6">
                ...
                dental cases. Our AI provides profrssional-grade insights.
              </p>
              <div className="flex flex-wrap gap-2 justify-center">
                <span className="px-3 py-1 bg-primary/10 text-primary text-sm rounded-full">
                  AI-Powered
      ...
      <div className="text-center mt-16">
          <SignUpButton mode="modal">
              <Button size={"lg"}>
                <ArrowRightIcon className="mr-2 size-5" color="#000000" />
                Get started now
              </Button>
          </SignUpButton>
      </div>
