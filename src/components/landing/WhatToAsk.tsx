...
function WhatToAsk() {
  return (
    <section className="relative py-32 px-6 outline-hidden bg-gradient-to-b from-background to-muted/20">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <div className="group relative">
                <article className="bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-6 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
                    ...
                    <div className="space-y-3 flex-1">
                      ...
                      <div className="bg-muted/30 rounded-2xl p-4">
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          ...
                          the best whitening silution for your budget
                        </p>
                        <div className="flex gap-2 mt-3">
                          <span className="px-2 py-1 bg-primary/10 text-primary text-sm rounded-full">
                            Cost Analysis
